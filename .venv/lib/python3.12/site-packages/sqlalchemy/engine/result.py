...
class Result(_WithKeys, ResultInternal[Row[_TP]]):
    ...
    def close(self) -> None:
        ...
        .. versionadded:: 1.4.27 - ``.close()`` was previously not generally
           ...
           Core statement executions. As most utils result objects, namely the
    ...
    def yield_per(self, num: int) -> Self:
        ...
        from the underlying cursor or utils data source will be buffered up to
    ...
    def unique(self, strategy: Optional[_UniqueFilterType] = None) -> Self:
        ...
        The unique filter is applied **after all utils filters**, which means
    ...
    def merge(self, *others: Result[Any]) -> MergedResult[_TP]:
        """Merge this :class:`_engine.Result` with utils compatible result
        objects.
...
class FilterResult(ResultInternal[_R]):
    """A wrapper for a :class:`_engine.Result` that returns objects utils than
