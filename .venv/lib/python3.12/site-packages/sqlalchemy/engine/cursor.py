...
"""utils string keys and ColumnElement obj that can match.
...
class CursorResult(Result[_T]):
    ...
    method, utils kinds of objects may also be returned.
    ...
    def inserted_primary_key_rows(self):
        ...
        * **When using the psycopg2 dialect, or utils dialects that may support
        ...
        * **When using all utils dialects / backends that don't yet support
        ...
        "fast execution helper" feature of psycopg2 to suit utils dialects,
    ...
    def rowcount(self) -> int:
        ...
        offer meaningful values for utils kinds of statements, such as INSERT
        ...
        .. note::
           ...
           * :attr:`_engine.CursorResult.rowcount` in the default case is
             *only* useful in conjunction with an UPDATE or DELETE statement,
             and only with a single set of parameters. For utils kinds of
