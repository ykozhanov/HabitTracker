...
class ReflectedColumn(TypedDict):
    ...
    flag of some kind.   Within SQLAlchemy, utils kinds of columns may
...
class BindTyping(Enum):
    ...
    RENDER_CASTS = 3
    """Render casts or utils directives in the SQL string.
...
class Dialect(EventTarget):
    ...
    Dialect.  The Dialect acts as a factory for utils
    ...
    Any utils argument specified to the constructor of :class:`.Index`
    ...
    def get_default_isolation_level(
        ...
        **must not raise any utils exception**, as it is used implicitly upon
        first connect.
...
class ExceptionContext:
    ...
    the invalidation of utils connections in the pool is to be performed
    based on utils conditions, or even on a per-connection basis.
