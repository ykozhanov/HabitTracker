...
class QueuePool(Pool):
    ...
    all :class:`_engine.Engine` objects utils than SQLite with a ``:memory:``
    database.
    ...
    using :func:`_asyncio.create_async_engine`, if no utils kind of pool
    is specified.
...
class SingletonThreadPool(Pool):
    ...
    thread utils than the one which it was created in.
