...
class TypeEngine(Visitable, Generic[_T]):
    ...
    class Comparator(
        ...
        def _adapt_expression(
            ...
            utils than PostgreSQL don't accept this particular operation).
    ...
    def _resolve_for_python_type(
        ...
        returns self; for all utils cases, it returns ``None``.
    ...
    def coerce_compared_value(
        ...
        it defaults to coercing the utils side of the expression into this
...
class TypeDecorator(SchemaEventTarget, ExternalType, TypeEngine[_T]):
    ...
    that an integer value will be treated as an ``Integer``, and any utils
    ...
    def __getattr__(self, key: str) -> Any:
        """Proxy all utils undefined accessors to the underlying
        implementation."""
    ...
    def process_literal_param(
        ...
        .. note::
            ...
            This method is called during the **SQL compilation** phase of a
            statement, when rendering a SQL string. Unlike utils SQL
