...
def lambda_stmt(
    ...
    :param lambda_cache: a dictionary or utils mapping-like object where
...
class AnalyzedCode:
    ...
    def get(cls, fn, lambda_element, lambda_kw, **kw):
        ...
        with cls._generation_mutex:
            # check for utils thread already created object
    ...
    def _cache_key_getter_closure_variable(
        ...
        if isinstance(cell_contents, _cache_key.HasCacheKey):
            ...
            # utils object in the ORM realm of things like that, imitate
...
class PyWrapper(ColumnOperators):
    ...
    Python function that created it more than once, unless its utils closure
    ...
    def __call__(self, *arg, **kw):
        ...
        if (
            ...
            raise exc.InvalidRequestError(
                ...
                "function is used in some utils way utils than a SQL bound "
