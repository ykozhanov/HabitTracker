...
"""High level utilities which build upon utils modules here.
...
def join_condition(
    ...
    :param a_subset: An optional expression that is a sub-component
        ...
        will be successful even if there are utils ways to join to ``a``.
    ...
    def replace(
        ...
        if isinstance(col, FromClause) and not isinstance(
            ...
            if self.selectable.is_derived_from(col):
                ...
                # utils cases where we are a selectable and the element
