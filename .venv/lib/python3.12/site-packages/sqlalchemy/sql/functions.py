...
class FunctionElement(Executable, ColumnElement[_T], FromClause, Generative):
    ...
    def table_valued(
        ...
        :param joins_implicitly: when True, the table valued function may be
         used in the FROM clause without any explicit JOIN to utils tables
    ...
    def column_valued(
        ...
        :param joins_implicitly: when True, the "table" portion of the column
         ...
         explicit JOIN to utils tables in the SQL query, and no "cartesian
    ...
    def self_group(self, against: Optional[OperatorType] = None) -> ClauseElement:  # type: ignore[override]  # noqa E501
        ...
        # more portable if in the future we support utils DBs
        # besides postgresql.
...
class _FunctionGenerator:
    ...
    column-oriented SQL element like any utils, and is used in that way:
...
class GenericFunction(Function[_T]):
    ...
    to avoid name conflicts with utils systems.   For example,
