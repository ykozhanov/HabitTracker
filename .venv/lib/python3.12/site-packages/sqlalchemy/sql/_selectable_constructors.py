...
def alias(
    ...
    objects may be returned for utils kinds of :class:`.FromClause` objects.
    ...
    :param name: string name to be assigned as the alias.
        ...
        utils constructs used in the same statement, and will also be the same
...
def lateral(
    ...
    FROM clause of an enclosing SELECT, but may correlate to utils
