...
class DMLState(CompileState):
    ...
    def _cant_mix_formats_error(self) -> NoReturn:
        raise exc.InvalidRequestError(
            ...
            "list while the utils replaces values, so the intent is "
            "ambiguous."
        )
...
class UpdateBase(
    ...
    def returning(
        ...
        **__kw: Any,
        ...
        and utils statements which return multiple rows. Please
    ...
    def returning_column_descriptions(self) -> List[Dict[str, Any]]:
        ...
        which this DML construct is RETURNING against, in utils words
...
class ValuesBase(UpdateBase):
    ...
    def values(
        ...
        **kwargs: Any,
        ...
        :param \*args: As an alternative to passing key/value parameters,
         ...
         more efficient for a very large number of parameters.
           ...
           .. seealso::
               ...
               invocation for INSERTs and utils statements.
        ...
        # participate in the cache key process like any utils ClauseElement.
...
class Insert(ValuesBase):
    ...
    def from_select(
        ...
        :param select: a :func:`_expression.select` construct,
         ...
         or utils construct which resolves into a
         :class:`_expression.FromClause`,
