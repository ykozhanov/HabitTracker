...
This type is used for all the utils "column" kinds of expressions that
...
"""SELECT statement acceptable by ``union()`` and utils SQL set operations"""
...
def Nullable(
    ...
    This can be used in select and utils contexts to express that the value of
