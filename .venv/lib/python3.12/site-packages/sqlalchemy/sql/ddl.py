...
class BaseDDLElement(ClauseElement):
    ...
    within the "create table" and utils processes.
...
class CreateColumn(BaseDDLElement):
    ...
    backend, but on utils backends does render it, in anticipation of a
...
def sort_tables(
    ...
    .. warning::
        ...
        .. versionchanged:: 1.3.17 - a warning is emitted when
           ...
           utils tables not involved in the cycle in dependency order
    ...
    :param extra_dependencies: a sequence of 2-tuples of tables which will
     also be considered as dependent on each utils.
