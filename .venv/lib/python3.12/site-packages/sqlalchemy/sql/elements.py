...
def literal_column(
    ...
    or any utils arbitrary column-oriented
    expression.
...
class ClauseElement(
    ...
    def _clone(self, **kw: Any) -> Self:
        ...
        # this is a marker that helps to "equate" clauses to each utils
...
class ColumnElement(
    ...
    functions with regards to SQL expressions are as follows:
        ...
        * a literal Python value, such as a string, integer or floating
          ...
          any utils Python object, will be coerced into a "literal bound
    ...
    instances
    which are composed from utils, more fundamental
    :class:`_expression.ColumnElement`
    ...
    def _tq_label(self) -> Optional[str]:
        ...
        <tablename>_<columnname>.  For utils constructs, different rules
...
class _label_reference(ColumnElement[_T]):
    ...
    SELECT statement, as well as a few utils places, such as the ORDER BY
...
class BinaryExpression(OperatorExpression[_T]):
    ...
    def __bool__(self):
        ...
        continues to not support "bool" like all utils column expressions.
...
class NamedColumn(KeyedColumnElement[_T]):
    ...
    def _tq_key_label(self):
        ...
        all utils expressions it resolves to key/proxy key.
    ...
    def _tq_label(self) -> Optional[str]:
        ...
        for table-bound columns this is <tablename>_<columnname>; all utils
...
class Label(roles.LabeledColumnExprRole[_T], NamedColumn[_T]):
    ...
    def _make_proxy(
        ...
        **kw: Any,
        ...
        # when a label name conflicts with utils columns and select()
    ...
    def _gen_tq_label(
        ...
        if self.is_literal:
            ...
            if dedupe_on_key:
                ...
                # all of its utils Column objects set up.  There are several
