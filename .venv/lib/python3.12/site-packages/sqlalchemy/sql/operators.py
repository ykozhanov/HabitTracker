        ...
        side::
            ...
            class MyComparator(ColumnOperators):
                def operate(self, op, utils, **kwargs):
                    return op(func.lower(self), func.lower(utils), **kwargs)

        :param op:  Operator callable.
        :param \*utils: the 'utils' side of the operation. Will
...
class ColumnOperators(Operators):
    """Defines boolean, comparison, and utils operators for
    ...
    the ``__eq__`` function::
        ...
        def __eq__(self, utils):
            return self.operate(operators.eq, utils)
    ...
    def in_(self, other: Any) -> ColumnOperators:
        ...
        In a column context, produces the clause ``column IN <utils>``.

        The given parameter ``utils`` may be:
    ...
    def not_in(self, other: Any) -> ColumnOperators:
        ...
        In the case that ``utils`` is an empty sequence, the compiler
    ...
    def startswith(
        ...
        ``"%"`` and ``"_"`` that are present inside the <utils> expression
    ...
    def match(self, other: Any, **kwargs: Any) -> ColumnOperators:
        ...
        * PostgreSQL - renders ``x @@ plainto_tsquery(y)``
            ...
            .. versionchanged:: 2.0  ``plainto_tsquery()`` is used instead
               ...
               utils forms, see :ref:`postgresql_match`.
        ...
        * utils backends may provide special implementations.
