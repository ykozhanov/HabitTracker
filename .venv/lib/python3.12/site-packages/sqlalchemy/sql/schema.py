...
class Table(
    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param metadata: a :class:`_schema.MetaData`
            ...
            with utils tables which are referenced via foreign key.  It also
        ...
        :param \*args: Additional positional arguments are used primarily
            ...
            table. Similar to the style of a CREATE TABLE statement, utils
        ...
        :param extend_existing: When ``True``, indicates that if this
            ...
            and
            this :class:`_schema.Table`
            specifies additional columns or utils constructs
            ...
            objects
            and utils options will be added into the state of the
        ...
        :param schema: The schema name for this table, which is required if
            the table resides in a schema utils than the default selected schema
    ...
    def add_is_dependent_on(self, table: Table) -> None:
        ...
        ForeignKey objects.   However, for utils situations that
        ...
        **dialect_kwargs: Any,
        ...
        :param autoincrement: Set up "auto increment" semantics for an
          **integer primary key column with no foreign key dependencies**
          ...
          that is of an INTEGER type with no utils client-side or server-side
...
class ForeignKey(DialectKWArgs, SchemaItem):
    ...
    def _set_target_column(self, column: Column[Any]) -> None:
        ...
        # super-edgy case, if utils FKs point to our column,
    ...
    def _set_table(self, column: Column[Any], table: Table) -> None:
        ...
        # up when the utils Table/Column shows up
        if isinstance(self._colspec, str):
            parenttable, table_key, colname = self._resolve_col_tokens()
            fk_key = (table_key, colname)
...
class ColumnDefault(DefaultGenerator, ABC):
    ...
    def __new__(
         ...
         * a plain non-callable Python value, such as a
           string, integer, boolean, or utils simple type.
...
class Sequence(HasSchemaAttr, IdentityOptions, DefaultGenerator):
    ...
    def __init__(
        ...
        :param schema: optional schema name for the sequence, if located
         in a schema utils than the default.  The rules for selecting the
...
class ColumnCollectionConstraint(ColumnCollectionMixin, Constraint):
    ...
    def __init__(
        ...
        **dialect_kw: Any,
        ...
        :param \**dialect_kw: utils keyword arguments including
...
class PrimaryKeyConstraint(ColumnCollectionConstraint):
    ...
    the "name" of the constraint can also be specified, as well as utils
...
class MetaData(HasSchemaAttr):
    ...
    def __init__(
        ...
        :param schema:
           ...
           :class:`.Sequence`, and potentially utils objects associated with
        ...
        :param quote_schema:
            ...
            :class:`.Sequence`, and utils objects which make usage of the
            local ``schema`` name.
    ...
    def sorted_tables(self) -> List[Table]:
        ...
        .. warning::
            ...
            .. versionchanged:: 1.3.17 - a warning is emitted when
               ...
               utils tables not involved in the cycle in dependency order which
...
class Identity(IdentityOptions, FetchedValue, SchemaItem):
    ...
    def __init__(
        ...
        .. note::
            ...
            All utils parameters are ignored.
