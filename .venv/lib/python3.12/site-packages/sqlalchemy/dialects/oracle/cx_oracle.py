...
environment variable.   cx_Oracle like most utils Oracle drivers will use
...
parameters.  While virtually no utils DBAPI assigns any use to the
                ...
                if bindparam.isoutparam:
                    ...
                    if hasattr(type_impl, "_cx_oracle_var"):
                        ...
                        if isinstance(type_impl, _LOBDataType):
                            ...
                            # utils LOB types go in directly
