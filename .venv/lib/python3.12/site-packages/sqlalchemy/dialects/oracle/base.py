...
.. note:: The implementation for the
   ...
   permissions or utils reasons, which is a common occurrence in Oracle
   installations.
   ...
   exception due to ``v$transaction`` not being readable as well as any utils
...
names using UPPERCASE text.   SQLAlchemy on the utils hand considers an
...
class OracleCompiler(compiler.SQLCompiler):
    ...
    def _get_nonansi_join_whereclause(self, froms):
        ...
        def visit_join(join):
            if join.isouter:
                ...
                # unconditionally regardless of operator or the utils side
    ...
    def returning_clause(
        ...
        for i, column in enumerate(
            ...
            # visited.   Ensure the statement itself didn't have utils
