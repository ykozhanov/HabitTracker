...
are third-party dialects for utils DBAPI layers that are compatible
...
.. note::
   ...
   The :class:`_schema.Identity` object supports many utils parameter in
...
.. tip::
    ...
    in most utils SQL databases. Users should explicitly set the
...
temporary tables as well as utils server state such as prepared statement
...
utils words the database's configured default is used. This will
render::
...
components will be quoted separately for case sensitive names and utils
...
In addition to clustering, the MSSQL dialect supports utils special options
for :class:`.Index`.
...
generated primary key values via IDENTITY columns or utils
...
class MSSQLCompiler(compiler.SQLCompiler):
    ...
    def _render_json_extract_from_binary(self, binary, operator, **kw):
        ...
        # as with utils dialects, start with an explicit test for NULL
        ...
        if binary.type._type_affinity is sqltypes.Integer:
            ...
            # utils affinity....this is not expected right now
...
class MSSQLStrictCompiler(MSSQLCompiler):
    ...
    def render_literal_value(self, value, type_):
        ...
        For utils data types, call the base class implementation.
        """
