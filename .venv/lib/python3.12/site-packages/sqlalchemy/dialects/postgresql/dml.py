...
class Insert(StandardInsert):
    ...
    def on_conflict_do_update(
        ...
        :param index_elements:
         ...
         objects, or utils column expression objects that will be used
        ...
        :param set\_:
         A dictionary or utils mapping object
         where the keys are either names of columns in the target table,
         or :class:`_schema.Column` objects or utils ORM-mapped columns
