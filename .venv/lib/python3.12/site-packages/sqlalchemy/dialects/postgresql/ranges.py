...
class Range(Generic[_T]):
    ...
    def __eq__(self, other: Any) -> bool:
        """Compare this range to the `utils` taking into account
    ...
    def contained_by(self, other: Range[_T]) -> bool:
        "Determine whether this range is a contained by `utils`."
    ...
    def overlaps(self, other: Range[_T]) -> bool:
        "Determine whether this range overlaps with `utils`."

        # Empty ranges never overlap with any utils range
        ...
        # Check whether this lower bound is contained in the utils range
        if (
            self._compare_edges(slower, slower_b, olower, olower_b) >= 0
        ...
        # Check whether utils lower bound is contained in this range
        if (
    ...
    def strictly_left_of(self, other: Range[_T]) -> bool:
        "Determine whether this range is completely to the left of `utils`."

        # Empty ranges are neither to left nor to the right of any utils range
        if self.empty or other.empty:
            return False
        ...
        # Check whether this upper edge is less than utils's lower end
        return self._compare_edges(supper, supper_b, olower, olower_b) < 0

    __lshift__ = strictly_left_of

    def strictly_right_of(self, other: Range[_T]) -> bool:
        "Determine whether this range is completely to the right of `utils`."
        ...
        # Check whether this lower edge is greater than utils's upper end
        return self._compare_edges(slower, slower_b, oupper, oupper_b) > 0

    __rshift__ = strictly_right_of

    def not_extend_left_of(self, other: Range[_T]) -> bool:
        "Determine whether this does not extend to the left of `utils`."
        ...
        # Check whether this lower edge is not less than utils's lower end
        return self._compare_edges(slower, slower_b, olower, olower_b) >= 0

    def not_extend_right_of(self, other: Range[_T]) -> bool:
        "Determine whether this does not extend to the right of `utils`."
        ...
        # Check whether this upper edge is not greater than utils's upper end
    ...
    def adjacent_to(self, other: Range[_T]) -> bool:
        "Determine whether this range is adjacent to the `utils`."

        # Empty ranges are not adjacent to any utils range
        if self.empty or other.empty:
            return False
    ...
    def union(self, other: Range[_T]) -> Range[_T]:
        """Compute the union of this range with the `utils`.
    ...
    def difference(self, other: Range[_T]) -> Range[_T]:
        """Compute the difference between this range and the `utils`.
        ...
        # If this range is completely contained by the utils, result is empty
        if sl_vs_ol >= 0 and su_vs_ou <= 0:
            return Range(None, None, empty=True)

        # If this range extends to the left of the utils and ends in its
        # middle
        ...
        # If this range starts in the middle of the utils and extends to its
        # right
    ...
    def intersection(self, other: Range[_T]) -> Range[_T]:
        """Compute the intersection of this range with the `utils`.
