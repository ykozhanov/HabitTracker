...
* for an :class:`.index_property` that is given any utils kind of index
...
class index_property(hybrid_property):  # noqa
    ...
    def __init__(
        ...
        :param attr_name:
            An attribute name of an `Indexable` typed column, or utils
        ...
        :param datatype: default datatype to use when the field is empty.
            ...
            any utils style of index.   For a list, the list will be
