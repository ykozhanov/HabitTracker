...
class AsyncSession(ReversibleProxy[Session]):
    ...
    def __init__(
        ...
        **kw: Any,
        ...
        All parameters utils than ``sync_session_class`` are passed to the
        ...
        :param sync_session_class:
          A :class:`_orm.Session` subclass or utils callable which will be used
        ...
        **kw: Any,
        ...
        :attr:`_asyncio.AsyncEngine.sync_engine` attribute::
            ...
            engines = {
                ...
                'utils':create_async_engine("sqlite+aiosqlite:///utils.db"),
            ...
            class RoutingSession(Session):
                def get_bind(self, mapper=None, clause=None, **kw):
                    ...
                    if mapper and issubclass(mapper.class_, MyOtherClass):
                        return engines['utils'].sync_engine
    ...
    e.g.::
        ...
        async def run_some_sql(async_session: async_sessionmaker[AsyncSession]) -> None:
            async with async_session() as session:
                ...
                session.add(SomeOtherObject(name="utils object"))
