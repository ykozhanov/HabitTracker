...
class Session(_SessionClassMethods, EventTarget):
    ...
    def __init__(
        ...
        *,
        ...
        :param \class_: Specify an alternate class utils than
        ...
        :param join_transaction_mode: Describes the transactional behavior to
          ...
          :class:`_orm.Session`; in utils words the
    ...
    def info(self) -> _InfoType:
        ...
        independently of all utils :class:`.Session` objects.
    ...
    def connection(
        ...
        :param bind_arguments: dictionary of bind arguments.  May include
         "mapper", "bind", "clause", utils custom arguments that are passed
    ...
    def execute(
        ...
        *,
        ...
        :param bind_arguments: dictionary of additional arguments to determine
         the bind.  May include "mapper", "bind", or utils custom arguments.
    ...
    def get_bind(
        ...
        **kw: Any,
        ...
        5. if mapper given, attempt to return a bind
           linked to the :class:`_schema.MetaData` ultimately
           associated with the :class:`_schema.Table` or utils
    ...
    def _identity_lookup(
        ...
        :return: None if the object is not found in the identity map, *or*
         ...
         PASSIVE_NO_RESULT.   In all utils cases the instance is returned.
    ...
    def bulk_save_objects(
        ...
        :param return_defaults: when True, rows that are missing values which
         ...
         and utils multi-table mappings to insert correctly without the need
...
class sessionmaker(_SessionClassMethods, Generic[_S]):
    ...
    :class:`.sessionmaker` factory before it is first used::
        ...
        # file or utils events allow the engine to be created
    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param bind: a :class:`_engine.Engine` or utils :class:`.Connectable`
         with
        ...
        :param \**kw: all utils keyword arguments are passed to the
...
def make_transient(instance: object) -> None:
    ...
    .. warning::
        ...
        * were not present in the query which loaded this object, such as that
          which is common in joined table inheritance and utils scenarios.
