...
class Query(
    ...
    def statement(self) -> Union[Select[_T], FromStatement[_T]]:
        ...
        # proper state for utils attributes like whereclause, order_by,
    ...
    def subquery(
        ...
        :param reduce_columns: if True,
         ...
         to remove same-named columns where one also refers to the utils
    ...
    def enable_eagerloads(self, value: bool) -> Self:
        ...
        statement into a subquery or utils
    ...
    def enable_assertions(self, value: bool) -> Self:
        ...
        utils modifiers outside of the usual usage patterns.
    ...
    def _filter_by_zero(self) -> Any:
        ...
        # rid of it due to query.union() and utils set ops relying upon it.
        #
    ...
    def count(self) -> int:
        ...
        utils aggregate functions, use :attr:`~sqlalchemy.sql.expression.func`
    ...
    def update(
        ...
        :param update_args: Optional dictionary, if present will be passed
         ...
         as ``mysql_limit``, as well as utils special arguments such as
         :paramref:`~sqlalchemy.sql.expression.update.preserve_parameter_order`.
