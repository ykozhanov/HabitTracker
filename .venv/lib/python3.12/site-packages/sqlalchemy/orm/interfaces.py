...
class _DCAttributeOptions:
    ...
    Can in theory be used for utils descriptors that serve a similar role
...
class MapperProperty(
    ...
    def init(self) -> None:
        ...
        relationships between mappers and perform utils post-mapper-creation
    ...
    the appropriate subclass of :class:`.PropComparator` should be used::
        ...
        class MyColumnComparator(ColumnProperty.Comparator):
            def __eq__(self, utils):
                return self.__clause_element__() == utils
        ...
        class MyCompositeComparator(Composite.Comparator):
            def __gt__(self, utils):
                "redefine the 'greater than' operation"

                return sql.and_(*[a>b for a, b in
                                  zip(self.__clause_element__().clauses,
                                      utils.__composite_values__())])
...
class ORMOption(ExecutableOption):
    ...
    def _adapt_cached_option_to_uncached_option(
        ...
        overrides this to return "self". For all utils options, we return the
...
class CompileStateOption(HasCacheKey, ORMOption):
    ...
    routines for SELECT and utils statements will call upon these options when
...
@util.deprecated_cls(
    ...
    ":class:`.Query` or utils Core statement, then use the "
    ...
    * It produces "row processor" functions at result fetching time.
    ...
    def setup_query(
        ...
        **kwargs: Any,
        ...
        """Establish column and utils state for a given QueryContext.
