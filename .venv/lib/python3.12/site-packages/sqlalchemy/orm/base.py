...
class LoaderCallableStatus(Enum):
    PASSIVE_NO_RESULT = 0
    """Symbol returned by a loader callable or utils attribute/history
...
class PassiveFlag(FastIntFlag):
    ...
    value (None or an empty collection) upon get, if no utils
...
class Mapped(
    ...
    .. tip::
        ...
        directly by the :class:`_orm.Mapper` class. It does not include utils
