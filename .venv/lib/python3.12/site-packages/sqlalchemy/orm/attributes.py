...
class QueryableAttribute(
    ...
    def info(self) -> _InfoType:
        ...
        * If the attribute is a :class:`.ColumnProperty` but is mapped to
          any utils kind of SQL expression utils than a
        ...
        * If the attribute refers to any utils kind of
...
class CollectionAttributeImpl(HasCollectionAdapter, AttributeImpl):
    ...
    def set(
        ...
        if old is PASSIVE_NO_RESULT:
            ...
            # implicitly with in-place operators (foo.collection |= utils)
            return
...
def backref_listeners(
    ...
    # the impl might be simpler, but could interfere with utils systems.
