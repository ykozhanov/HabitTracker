...
The targeted decoration tries not to rely on utils methods in the underlying
...
class collection:
    ...
    def converter(fn):
        ...
        of dictionary values, and utils types will simply be iterated::

            @collection.converter
            def convert(self, utils): ...
