...
class QueryContext:
    ...
    def __init__(
        ...
        # bot.py is pulled from context.compile_state.current_path.
...
class DMLReturningColFilter:
    ...
    def __init__(self, target_mapper, immediate_dml_mapper):
        if (
            ...
            # joined inh, or in theory utils kinds of multi-table mappings
...
class FromStatement(GroupedElement, Generative, TypedReturnsRows[_TP]):
    ...
    :class:`.ReturnsRows` and utils classes including:
...
class ORMSelectCompileState(ORMCompileState, SelectState):
    ...
    def _create_entities_collection(cls, query, legacy):
        ...
        the full collection of _MapperEntity and utils _QueryEntity objects.
...
class _ORMColumnEntity(_ColumnEntity):
    ...
    def __init__(
        ...
        if orm_key:
            ...
            # SQL ColumnElement, like a CASE() or utils expression.
