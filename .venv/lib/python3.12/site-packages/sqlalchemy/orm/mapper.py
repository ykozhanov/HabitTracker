...
class Mapper(
    ...
    utils relational structure, so that ORM operations against the class may
    proceed.
    ...
    def __init__(
        ...
        :param local_table: The :class:`_schema.Table` or utils
        ...
        :param eager_defaults: if True, the ORM will immediately fetch the
          ...
          .. versionchanged:: 2.0.0  RETURNING now works with multiple rows
             ...
             among utils things allows the :paramref:`.Mapper.eager_defaults`
        ...
        :param inherits: A mapped class or the corresponding
          ...
          of the utils mapper's class.   When using Declarative, this argument
    ...
    the :class:`_orm.Mapper` which is parent to all utils :class:`_orm.Mapper`
    ...
    """A collection of :class:`_schema.Column` or utils scalar expression
            ...
            if self.single:
                ...
                if self.concrete:
                    ...
                    if self.inherit_condition is None:
                        ...
                        # full table which could pull in utils stuff we don't
    ...
    def _configure_properties(self) -> None:
        ...
        # that's given.  For utils properties, set them up in _props now.
    ...
    def _property_from_column(
        ...
        :class:`_schema.Column` or utils SQL expression object."""
    ...
    def get_property(
        ...
        try:
            ...
            raise sa_exc.InvalidRequestError(
                ...
                "was indicated from utils mappers or configure events, ensure "
    ...
    def _iterate_polymorphic_properties(self, mappers=None):
        ...
        if not mappers:
            ...
            # from utils mappers, as these are sometimes dependent on that
    ...
    def is_sibling(self, other: Mapper[Any]) -> bool:
        """return true if the utils mapper is an inheriting sibling to this
...
def configure_mappers() -> None:
    ...
    * :meth:`.MapperEvents.mapper_configured` - called as each individual
      ...
      mapper state except for backrefs set up by utils mappers that are still
      to be configured.
    ...
    * :meth:`.MapperEvents.after_configured` - called once after
      ...
      Note that the calling application may still have utils mappings that
      ...
      if they are in utils :class:`_orm.registry` collections not part of the
        ...
        for mapper in reg._mappers_to_configure():
            ...
            if getattr(mapper, "_configure_failed", False):
                e = sa_exc.InvalidRequestError(
                    ...
                    "can't proceed with initialization of utils "
