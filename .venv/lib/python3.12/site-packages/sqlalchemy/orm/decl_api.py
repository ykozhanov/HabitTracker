...
class declared_attr(interfaces._MappedAttribute[_T], _declared_attr_common):
    ...
    define dynamically generated column expressions and utils Declarative
    attributes.
...
def declarative_mixin(cls: Type[_T]) -> Type[_T]:
    ...
    SQLAlchemy declarative mixin classes when no utils context is present.
...
class DeclarativeBase(
    ...
    .. versionadded:: 2.0  Added :class:`.DeclarativeBase`, so that declarative
       ...
       and utils subclassing-oriented APIs should be seen as
    ...
    **never accessed by a mapped class without being called explicitly via
    ...
    if typing.TYPE_CHECKING:
        ...
        refer to utils kinds of :class:`_sql.FromClause` such as
...
class registry:
    ...
    * :meth:`_orm.registry.map_imperatively` will produce a
    ...
    def configure(self, cascade: bool = False) -> None:
        ...
        utils registries, this registry is said to be *dependent* on those
    ...
    def dispose(self, cascade: bool = False) -> None:
        ...
        If this registry contains mappers that are dependencies of utils
