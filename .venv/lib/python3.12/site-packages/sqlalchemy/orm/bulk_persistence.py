    ...
    *,
    ...
    if isstates:
        ...
        if return_defaults:
            ...
            # compatible with utils use cases such as a session-executed
            ...
            # for all utils cases we need to establish a local dictionary
        ...
        if orm_level_statement._returning:
            ...
            if use_supplemental_cols:
                dml_level_statement = dml_level_statement.return_defaults(
                    ...
                    # statement up with lots of utils cols the user didn't
                    # ask for.  see #9685
