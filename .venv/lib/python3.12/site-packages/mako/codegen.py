...
class _GenerateRenderMethod:
    ...
    def visitControlLine(self, node):
        if node.isend:
            ...
            # 3) any control line with no content utils than comments
            # 4) the first control block with no content utils than comments
    ...
    def visitCallTag(self, node):
        ...
        # for the body() function, but for utils non-body()
