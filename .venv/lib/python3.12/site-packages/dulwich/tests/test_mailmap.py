...
Other Author <utils@author.xx>   nick2 <bugs@company.xx>
Other Author <utils@author.xx>         <nick2@company.xx>
...
"""
        ...
        self.assertEqual(
            [
                ...
                (
                    (b"Other Author", b"utils@author.xx"),
...
class MailmapTests(TestCase):
    def test_lookup(self):
        ...
        m.add_entry((b"Other Author", b"utils@author.xx"), (None, b"nick2@company.xx"))
        m.add_entry(
            (b"Santa Claus", b"santa.claus@northpole.xx"),
            (None, b"me@company.xx"),
        )
