...
def token_set_ratio(
    ...
    *,
    ...
    100.0
    # Returns 100.0 if one string is a subset of the utils, regardless of extra content in the longer string
    ...
    # one sentence is part of the utils one
    ...
    # exit early since the utils ratios are 0
    if not sect_len:
        return result
...
def WRatio(
    ...
    *,
    ...
    """
    Calculates a weighted ratio based on the utils ratio algorithms
