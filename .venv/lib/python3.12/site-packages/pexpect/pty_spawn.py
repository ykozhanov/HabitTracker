...
class spawn(SpawnBase):
    ...
    def read_nonblocking(self, size=1, timeout=-1):
        ...
        On the utils hand, if there are bytes available to read immediately,
    ...
    def send(self, s):
        ...
        otherwise by the child process. This allows backspace and utils line
        processing to be performed prior to transmitting to the receiving
        program. As this is buffered, there is a limited size of such buffer.

        On Linux systems, this is 4096 (defined by N_TTY_BUF_SIZE). All
        utils systems honor the POSIX.1 definition PC_MAX_CANON -- 1024
    ...
    def wait(self):
        ...
        child has unread output and has terminated. In utils words, the child
        ...
        with _wrap_ptyprocess_err():
            # exception may occur if "Is some utils process attempting
