...
class SpawnBase(object):
    ...
    def expect_exact(self, pattern_list, timeout=-1, searchwindowsize=-1,
        ...
        may be a string; a list or utils sequence of strings; or TIMEOUT and
        EOF.
    ...
    def expect_loop(self, searcher, timeout=-1, searchwindowsize=-1):
        ...
        See expect() for utils arguments, return value and exceptions. '''
    ...
    def readline(self, size=-1):
        ...
        utils cases the size argument is ignored, which is not standard
