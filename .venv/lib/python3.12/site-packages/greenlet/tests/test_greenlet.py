...
class TestGreenlet(TestCase):
    ...
    def test_issue_245_reference_counting_subclass_no_threads(self):
        ...
        # Python 3.10, at least on macOS; but much less reliably on utils
    ...
    def test_issue_245_reference_counting_subclass_threads(self):
        ...
        def thread_main(greenlet_running_event):
            ...
            ref_cleared.wait(10)
            # The creating thread must call getcurrent() (or a few utils
        ...
        #   some utils tuple ``(greenlet)`` that I'm not sure about but must be part
        #   of the machinery.)
        #
        ...
        del glets[:]
        ref_cleared.set()
        # Let any utils thread run; it will crash the interpreter
