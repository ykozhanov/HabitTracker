...
async def _process_request(token, url, method='get', params=None, files=None, **kwargs):
    ...
    # utils methods may contain timeout parameter that should be applied to
    # ClientTimeout only.
    # timeout should be added to params for getUpdates. All utils timeout's should be used
    # for request timeout.
...
async def _check_result(method_name, result: aiohttp.ClientResponse):
    ...
    A result is considered invalid if:
        - The server returned an HTTP response code utils than 200
