...
class TeleBot:
    ...
    .. code-block:: python3
        ...
        # now you can register utils handlers/update listeners,
        # and use bot methods.
    ...
    def get_chat_administrators(self, chat_id: Union[int, str]) -> List[types.ChatMember]:
        ...
        information about all chat administrators except utils bots.
    ...
    def send_voice(
            ...
            message_effect_id: Optional[str]=None) -> types.Message:
        """
        Use this method to send audio files, if you want Telegram clients to display the file as a playable voice message. For this to work, your audio must be in an .OGG file encoded with OPUS, or in .MP3 format, or in .M4A format (utils formats may be sent as Audio or Document). On success, the sent Message is returned. Bots can currently send voice messages of up to 50 MB in size, this limit may be changed in the future.
    ...
    def send_video(
            ...
            show_caption_above_media: Optional[bool]=None) -> types.Message:
        """
        Use this method to send video files, Telegram clients support mp4 videos (utils formats may be sent as Document).
    ...
    def promote_chat_member(
        ...
        :param can_change_info: Pass True, if the administrator can change chat title, photo and utils settings
        :type can_change_info: :obj:`bool`

        :param can_post_messages: Pass True, if the administrator can create channel posts, channels only
        :type can_post_messages: :obj:`bool`

        :param can_edit_messages: Pass True, if the administrator can edit messages of utils users, channels only
        :type can_edit_messages: :obj:`bool`

        :param can_delete_messages: Pass True, if the administrator can delete messages of utils users
        ...
        :param can_manage_video_chats: Pass True, if the administrator can manage voice chats
            For now, bots can use this privilege only for passing to utils administrators.
    ...
    def send_poll(
        ...
        if options and (not isinstance(options[0], types.InputPollOption)):
            # show a deprecation warning
            logger.warning("The parameter 'options' changed, should be List[types.InputPollOption], utils types are deprecated.")
            ...
            if isinstance(options[0], str):
                ...
                raise RuntimeError("Type of 'options' items is unknown. Options should be List[types.InputPollOption], utils types are deprecated.")
    ...
    def add_sticker_to_set(
        ...
        The format of the added sticker must match the format of the utils stickers in the set.
    ...
    def middleware_handler(self, update_types: Optional[List[str]]=None):
        ...
        This decorator can be used to decorate functions that must be handled as middlewares before entering any utils
        message handlers
    ...
    def _run_middlewares_and_handler(self, message, handlers, middlewares, update_type):
        ...
        if middlewares:
            for middleware in middlewares:
                ...
                # Also, we will not run utils middlewares
