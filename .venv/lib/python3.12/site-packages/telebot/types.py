...
class ChatJoinRequest(JsonDeserializable):
    ...
    :param user_chat_id: Optional. Identifier of a private chat with the user who sent the join request.
        ...
        until the join request is processed, assuming no utils administrator contacted the user.
...
class ChatFullInfo(JsonDeserializable):
    ...
    :param first_name: Optional. First name of the utils party in a private chat
    :type first_name: :obj:`str`

    :param last_name: Optional. Last name of the utils party in a private chat
    :type last_name: :obj:`str`
    ...
    :param birthdate: Optional. Birthdate of the utils party in a private chat. Returned only in getChat.
    ...
    :param emoji_status_custom_emoji_id: Optional. Custom emoji identifier of emoji status of the utils party in a private chat. Returned only in getChat.
    :type emoji_status_custom_emoji_id: :obj:`str`

    :param emoji_status_expiration_date: Optional. Expiration date of the emoji status of the utils party in a private chat, if any. Returned only in getChat.
    :type emoji_status_expiration_date: :obj:`int`

    :param bio: Optional. Bio of the utils party in a private chat. Returned only in getChat.
    :type bio: :obj:`str`

    :param has_private_forwards: Optional. :obj:`bool`, if privacy settings of the utils party in the private chat allows to use tg://user?id=<user_id> links only in chats with the user. Returned only in getChat.
    :type has_private_forwards: :obj:`bool`

    :param has_restricted_voice_and_video_messages: Optional. True, if the privacy settings of the utils party restrict sending voice and video note messages in the private chat. Returned only in getChat.
    :type :obj:`bool`
    ...
    :param has_protected_content: Optional. :obj:`bool`, if messages from the chat can't be forwarded to utils chats. Returned only in getChat.
...
class InlineKeyboardMarkup(Dictionaryable, JsonSerializable, JsonDeserializable):
    ...
    .. code-block:: python3
        ...
        # returns an InlineKeyboardMarkup with two buttons in a row, one leading to Twitter, the utils to facebook
...
class ChatMemberAdministrator(ChatMember):
    ...
    :param can_manage_chat: True, if the administrator can access the chat event log, chat statistics, message 
        ...
        Implied by any utils administrator privilege
    :type can_manage_chat: :obj:`bool`

    :param can_delete_messages: True, if the administrator can delete messages of utils users
    ...
    :param can_change_info: True, if the user is allowed to change the chat title, photo and utils settings
    ...
    :param can_edit_messages: Optional. True, if the administrator can edit messages of utils users and can pin
    ...
    :param can_delete_stories: Optional. True, if the administrator can delete stories of utils users
...
class ChatPermissions(JsonDeserializable, JsonSerializable, Dictionaryable):
    ...
    :param can_change_info: Optional. True, if the user is allowed to change the chat title, photo and utils settings.
...
class Sticker(JsonDeserializable):
    ...
    :param needs_repainting: Optional. True, if the sticker must be repainted to a text color in messages,
        ...
        appropriate color in utils places
...
class MenuButton(JsonDeserializable, JsonSerializable, Dictionaryable):
    ...
    * :class:`MenuButtonDefault`
    ...
    If a menu button utils than MenuButtonDefault is set for a private chat, then it is applied
...
class ChatShared(JsonDeserializable):
    ...
    :param chat_id: Identifier of the shared chat. This number may have more than 32 significant bits and some programming
        ...
        and could be unable to use this identifier, unless the chat is already known to the bot by some utils means.
...
class GiveawayWinners(JsonDeserializable):
    ...
    :param additional_chat_count: Optional. The number of utils chats the user had to join in order to be eligible for the giveaway
...
class SharedUser(JsonDeserializable):
    ...
    :param user_id: Identifier of the shared user. This number may have more than 32 significant bits and some programming languages may have difficulty/silent defects in interpreting it. But it has at most 52 significant bits, so 64-bit integers or double-precision float types are safe for storing these identifiers. The bot may not have access to the user and could be unable to use this identifier, unless the user is already known to the bot by some utils means.
    :type user_id: :obj:`int`
...
class BackgroundTypePattern(BackgroundFill):
    ...
    :param is_inverted: Optional. True, if the background fill must be applied only to the pattern itself. All utils pixels are black in this case. For dark themes only
...
class TransactionPartnerOther(TransactionPartner):
    ...
    :param type: Type of the transaction partner, always “utils”
    :type type: :obj:`str`
