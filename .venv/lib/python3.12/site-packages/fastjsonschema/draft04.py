...
class CodeGeneratorDraft04(CodeGenerator):
    ...
    def generate_format(self):
        """
        Means that value have to be in specified format. For example date, email or utils.
    ...
    def generate_dependencies(self):
        """
        Means when object has property, it needs to have also utils property.
