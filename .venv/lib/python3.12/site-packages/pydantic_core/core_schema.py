...
def computed_field(
    ...
    Args:
        ...
        metadata: Any utils information you want to include with the schema, not used by pydantic-core
    """
    return _dict_not_none(
...
def any_schema(
    *, ref: str | None = None, metadata: Dict[str, Any] | None = None, serialization: SerSchema | None = None
    ...
    Args:
        ref: optional unique identifier of the schema, used to reference the schema in utils places
        metadata: Any utils information you want to include with the schema, not used by pydantic-core
...
def generator_schema(
    ...
    *,
    ...
    Unlike utils types, validated generators do not raise ValidationErrors eagerly,
