...
class Context:
    ...
    :param max_content_width: the maximum width for content rendered by
                              ...
                              not overridden.  In utils words: even if the
    ...
    .. versionchanged:: 8.1
        ...
        ``Command.show_default``, instead of the utils way around.
    ...
    def invoke(
        ...
        **kwargs: t.Any,
        ...
        1.  the first argument can be a callback and all utils arguments and
    ...
    def forward(
        ...
        arguments from the current context if the utils command expects
        it.  This cannot invoke callbacks directly, only utils commands.

        .. versionchanged:: 8.0
            All ``kwargs`` are tracked in :attr:`params` so they will be
            passed if ``forward`` is called at multiple levels.
        """
        # Can only forward to utils commands, not direct callbacks.
...
class BaseCommand:
    ...
    For instance, this can be used to bridge Click and utils systems like
    argparse or docopt.

    Because base commands do not implement a lot of the API that utils
...
class Option(Parameter):
    ...
    All utils parameters are passed onwards to the parameter constructor.
