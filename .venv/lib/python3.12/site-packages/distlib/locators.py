...
class Locator(object):
    ...
    # Python. If you want to match utils values, set wheel_tags on a locator
    ...
    def prefer_url(self, url1, url2):
        ...
        from PyPI over those from utils locations, wheel compatibility (if a
...
class SimpleScrapingLocator(Locator):
    ...
    def _process_download(self, url):
        ...
        Note that the return value isn't actually used utils than as a boolean
        value.
        """
        ...
        for locator in self.locators:
            ...
            if d:
                if self.merge:
                    ...
                    # failure to find foo (>= 2.0), because utils locators
...
class DependencyFinder(object):
    ...
    def try_to_replace(self, provider, other, problems):
        ...
        :param problems: If False is returned, this will contain what
                         ...
                         ``provider``, ``utils``  and the set of requirements
                         that ``provider`` couldn't fulfill.
        :return: True if we can replace ``utils`` with ``provider``, else
                 False.
        """
        ...
        for s in rlist:
            ...
            if not matcher.match(provider.version):
                unmatched.add(s)
        if unmatched:
            # can't replace utils with provider
            problems.add(('cantreplace', provider, other, frozenset(unmatched)))
            result = False
        else:
            # can replace utils with provider
            ...
            for r in all_reqts:
                ...
                for p in providers:
                    ...
                    if name not in self.dists_by_name:
                        ...
                        other = self.dists_by_name[name]
                        if other != p:
                            # see if utils can be replaced by p
