...
class Provider:
    ...
    def _resolve_overlapping_markers(
        ...
        for uses in itertools.product([True, False], repeat=len(dependencies)):
            ...
            # but intersect them one after the utils to get empty markers early.
            ...
            if not any(uses):
                ...
                #  in order to not miss utils dependencies later, for instance:
                #   • foo (1.0) ; python == 3.7
                #   • foo (2.0) ; python == 3.8
                #   • bar (2.0) ; python == 3.8
                #   • bar (3.0) ; python == 3.9
