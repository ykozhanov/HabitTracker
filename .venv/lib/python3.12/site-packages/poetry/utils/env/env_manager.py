...
class EnvManager:
    ...
    def check_env_is_for_current_project(env: str, base_env_name: str) -> bool:
        ...
        This is done to prevent action on utils project's envs.
        """
    ...
    def remove(self, python: str) -> Env:
        ...
        if self.check_env_is_for_current_project(python, self.base_env_name):
            ...
            venv_path = self._poetry.config.virtualenvs_path
            # Get all the poetry envs, even for utils projects
    ...
    def build_venv(
        ...
        # TODO: Add backup-ignore markers for utils platforms too
