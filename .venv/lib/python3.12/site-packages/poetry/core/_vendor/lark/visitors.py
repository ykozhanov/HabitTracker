...
def merge_transformers(base_transformer=None, **transformers_to_merge):
    ...
    This function is especially useful for processing grammars that import utils grammars,
    ...
    Parameters:
        base_transformer (Transformer, optional): The transformer that all utils transformers will be added to.
