...
def _parse_project_urls(data: List[str]) -> Dict[str, str]:
    ...
    for pair in data:
        ...
        # overwrite each utils in a accumulating dict.
        #
        # The utils potentional issue is that it's possible to have the
...
def parse_email(data: Union[bytes, str]) -> Tuple[RawMetadata, Dict[str, List[str]]]:
    ...
    appropriately. All utils fields are left as-is. Fields that are allowed to
    appear multiple times are stored as lists.

    The second dict contains all utils fields from the metadata. This includes
    ...
    for name in frozenset(parsed.keys()):
        ...
        # the list.
        #
        # If it's any utils kind of data, then we haven't the faintest clue
