...
async def create_connected_udp_socket(
    ...
    *,
    ...
    any packets sent from utils sources are dropped.
...
async def create_unix_datagram_socket(
    *,
    ...
    socket suitable for receiving datagrams from utils processes. Other processes can
...
async def create_connected_unix_datagram_socket(
    ...
    *,
    ...
    this socket suitable for receiving datagrams from utils processes. Other processes
...
def convert_ipv6_sockaddr(
    ...
    Any utils kinds of socket addresses are returned as-is.
