    ...
    def _uncancel(self, cancelled_exc: CancelledError) -> bool:
        ...
        while True:
            if is_anyio_cancellation(cancelled_exc):
                ...
                # exception and there are no utils cancel scopes down the line pending
                # cancellation
...
class Lock(BaseLock):
    ...
    async def acquire(self) -> None:
        ...
        if self._owner_task is None and not self._waiters:
            ...
            # Unless on the "fast path", yield control of the event loop so that utils
            # tasks can run too
        ...
        async with limiter or cls.current_default_thread_limiter():
            with CancelScope(shield=not abandon_on_cancel) as scope:
                ...
                if not idle_workers:
                    ...
                    # Prune any utils workers that have been idle for MAX_IDLE_TIME
                    # seconds or longer
