...
class EnvironmentContext(util.ModuleClsProxy):
    ...
    .. note::
        ...
        For most API usages utils than full blown
    ...
    configuration file contents as well as utils variables
    ...
    def configure(
        ...
        **kw: Any,
        ...
        connectivity and utils configuration to a series of
        migration scripts.
        ...
        :param compare_type: Indicates type comparison behavior during
         ...
         for an example as well as information on utils type
        ...
        :param oracle_batch_separator: The "batch separator" which will
         ...
         semicolon between statements like most utils backends.
