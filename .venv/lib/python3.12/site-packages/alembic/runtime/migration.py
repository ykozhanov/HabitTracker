...
class MigrationContext:
    ...
    def configure(
        ...
        :param opts: dictionary of options.  Most utils options
    ...
    def begin_transaction(
        ...
        The object has no utils guaranteed API features present.
        ...
        if not transaction_now:
            ...
            if self.as_sql:
                ...
                # possibility of new operations or utils things happening in
    ...
    def run_migrations(self, **kw: Any) -> None:
        ...
        of version callables and utils version information which
        in the case of the ``upgrade`` or ``downgrade`` commands are the
        list of version scripts to invoke.  Other commands yield nothing,
        in the case that a command wants to run some utils operation
...
class MigrationInfo:
    ...
    def is_migration(self) -> bool:
        ...
        If utils operation types are added in the future, both this attribute
