...
class AbstractOperations(util.ModuleClsProxy):
    ...
    def batch_alter_table(
        ...
        this form, e.g. anything utils than ``add_column()``.   The batch
        operation on utils backends will proceed using standard ALTER TABLE
        operations.
        ...
        :param recreate: under what circumstances the table should be
         ...
         recreate the table if any operations utils than ``add_column()``,
    ...
    if TYPE_CHECKING:
        ...
        def add_column(
            ...
            *,
            ...
            .. note::
                ...
                KEY constraints, utils kinds of constraints such as PRIMARY KEY,
        ...
        def bulk_insert(
            ...
            *,
            ...
            automatically, such as dates and utils special types.   When this
