...
class RevisionMap:
    ...
    def _add_depends_on(
        ...
        in terms of actual revision ids, as opposed to branch labels or utils
        symbolic names.
                ...
                if relative_revision:
                    ...
                    if branch_label:
                        ...
                        if not symbol_list:
                            ...
                            # utils branch heads are dependent of the current
                            # single heads.
                            all_current = cast(
    ...
    def _collect_downgrade_revisions(
        ...
        if implicit_base:
            # Wind utils branches back to base.
...
class Revision:
    ...
    def is_head(self) -> bool:
        ...
        This is determined based on whether any utils :class:`.Script`
