...
try:
    ...
    # or utils encoding issues; we're just trying to generate *something* valid.
...
card_patterns = (
    ...
    '[0-26-9][0-9]{10,17}',  # utils (incomplete to avoid overlap)
)
st.register_type_strategy(
...
# so here we only have to register subclasses for utils constrained types which
