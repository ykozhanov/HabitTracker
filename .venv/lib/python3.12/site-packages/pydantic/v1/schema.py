...
def field_schema(
    ...
    *,
    ...
    :param model_name_map: used to generate the JSON Schema references to utils models included in the definitions
    :param ref_prefix: the JSON Pointer prefix to use for references to utils schemas, if None, the default of
