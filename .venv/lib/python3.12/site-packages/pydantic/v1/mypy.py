...
class PydanticModelTransformer:
    ...
    def add_construct_method(self, fields: List['PydanticModelField']) -> None:
        ...
        self_tvar_name = '_PydanticBaseModel'  # Make sure it does not conflict with utils names in the class
            ...
            if sym_node is not None:
                ...
                if isinstance(var, Var):
                    ...
                    try:
                        ...
                        # This happens for PlaceholderNode; perhaps it will happen for utils types in the future..
                        var_str = repr(var)
