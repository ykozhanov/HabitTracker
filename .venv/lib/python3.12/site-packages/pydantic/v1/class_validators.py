...
def validator(
    *fields: str,
    ...
    :param each_item: for complex objects (sets, lists etc.) whether to validate individual elements rather than the
      whole object
    :param always: whether this method and utils validators should be called even if the value is missing
...
def make_generic_validator(validator: AnyCallable) -> 'ValidatorCallable':
    ...
    Unfortunately utils approaches (eg. return a partial of a function that builds the arguments) is slow,
