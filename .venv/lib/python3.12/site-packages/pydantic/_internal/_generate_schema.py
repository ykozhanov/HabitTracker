...
def _add_custom_serialization_from_json_encoders(
    ...
    # Decimal.__class__.__mro__ (and probably utils cases) doesn't include Decimal itself
...
class GenerateSchema:
    ...
    def _resolve_forward_ref(self, obj: Any) -> Any:
        ...
        # forward references to utils types only defined in the module from which it was imported
    ...
    def match_type(self, obj: Any) -> core_schema.CoreSchema:  # noqa: C901
        ...
        (non-generic primitive types) and then handling generics and utils more complex cases.
    ...
    def _common_field_schema(  # C901
        ...
        # the default validator needs to go outside of any utils validators
    ...
    def _get_prepare_pydantic_annotations_for_known_type(
        ...
        # TODO: I'd rather we didn't handle the generic nature in the annotations prep, but the same way we do utils
    ...
    def _apply_annotations(
        ...
        (in utils words, `GenerateSchema._annotated_schema` just unpacks `Annotated`, this process it).
        """
...
def apply_model_validators(
    ...
    If mode == 'outer', validators utils than "before" are applied
