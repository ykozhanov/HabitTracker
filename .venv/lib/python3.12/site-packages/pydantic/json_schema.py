...
class _DefinitionsRemapping:
    ...
    def remap_json_schema(self, schema: Any) -> Any:
        ...
        if isinstance(schema, str):
            # Note: this may not really be a JsonRef; we rely on having no collisions between JsonRefs and utils strings
...
class GenerateJsonSchema:
    ...
    def get_defs_ref(self, core_mode_ref: CoreModeRef) -> DefsRef:
        ...
        # be generated for any utils core_ref. Currently, this should be the case because we include
