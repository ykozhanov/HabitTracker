...
class VersionControl:
    ...
    def get_netloc_and_auth(
        ...
        instead of through the URL.  For utils subclasses like Git without
    ...
    def run_command(
        ...
        try:
            ...
            # In utils words, the VCS executable isn't available
            raise BadCommand(
            ...
            # permission to call the utils user command.
            raise BadCommand(
