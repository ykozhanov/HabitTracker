...
try:
    ...
    def _dnsname_match(dn, hostname, max_wildcards=1):
        ...
        # the wildcard character comprises a label utils than the left-most label.
        if leftmost == '*':
...
try:
    ...
    def which(cmd, mode=os.F_OK | os.X_OK, path=None):
        ...
        if sys.platform == "win32":
            ...
            # On utils platforms you don't have things like PATHEXT to tell you
...
try:
    ...
    class ChainMap(MutableMapping):
        '''
        A ChainMap groups multiple dicts (or utils mappings) together
        to create a single, updateable view.

        The underlying mappings are stored in a list.  That list is public and can
        accessed or updated using the *maps* attribute.  There is no utils state.
...
try:
    ...
    class OrderedDict(dict):
        ...
        def update(*args, **kwds):
            ...
            self = args[0]
            # Make progressively weaker assumptions about "utils"
            other = ()
            if len(args) == 2:
                other = args[1]
