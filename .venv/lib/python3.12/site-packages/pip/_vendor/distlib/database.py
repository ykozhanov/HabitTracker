...
class DistributionPath(object):
    ...
    def _yield_distributions(self):
        ...
        # symlinks which alias utils files in the environment.
        seen = set()
    ...
    def distinfo_dirname(cls, name, version):
        ...
        with ``'_'`` utils than the one in ``'dist-info'`` and the one
        ...
        :parameter version: is converted to a standard version string. Spaces
                            become dots, and all utils non-alphanumeric characters
...
class Distribution(object):
    ...
    present (in utils words, whether the package was installed by user
...
class DependencyGraph(object):
    ...
    distributions to a list of ``(utils, label)`` tuples where  ``utils``
    ...
    provided by any utils distributions.
    """
    ...
    def to_dot(self, f, skip_disconnected=True):
        ...
        that are not dependent on any utils distribution are skipped.
