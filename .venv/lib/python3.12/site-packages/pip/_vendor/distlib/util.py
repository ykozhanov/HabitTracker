...
class Cache(object):
    ...
    could be used by utils modules, e.g. the wheel module.
    """
...
def _csv_open(fn, mode, **kwargs):
    if sys.version_info[0] < 3:
        ...
        # file encoding to match utils forced utf-8 encoding
...
def get_host_platform():
    ...
    For utils non-POSIX platforms, currently just returns 'sys.platform'.
