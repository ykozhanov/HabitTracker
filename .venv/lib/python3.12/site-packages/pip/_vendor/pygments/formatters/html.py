...
class HtmlFormatter(Formatter):
    ...
    `nowrap`
        ...
        around the tokens. This disables most utils options (default: ``False``).
    ...
    `linenos`
        ...
        one containing the line numbers, the utils the whole code.  This is
    ...
    **Subclassing the HTML formatter**
    ...
    utils generators. These may add some HTML code to the one generated by
    `_format_lines()`, either by modifying the lines generated by the latter,
    then yielding them again with ``(1, line)``, and/or by yielding utils HTML
    code before or after the lines, with ``(0, html)``. The distinction between
    source lines and utils code makes it possible to wrap the generator multiple
    times.
    ...
    def _wrap_tablelinenos(self, inner):
        ...
        # content in the utils cell also is wrapped in a div, some browsers in
