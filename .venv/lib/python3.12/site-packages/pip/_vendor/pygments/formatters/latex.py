...
class LatexFormatter(Formatter):
    ...
    The special command used here (``\PY``) and all the utils macros it needs
    ...
    `nowrap`
        ...
        ``\begin{Verbatim}`` environment. This disables most utils options
        (default: ``False``).
...
class LatexEmbeddedLexer(Lexer):
    ...
    strings and comments. All utils consecutive tokens are merged and
