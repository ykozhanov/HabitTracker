...
class Connection(metaclass=ConnectionMeta):
    ...
    async def set_type_codec(self, typename, *,
        ...
        .. note::
           ...
           and some utils functionality, such as
    ...
    async def _do_execute(
        ...
        *,
        ...
        try:
            ...
            # connection and all utils connections of the pool this
...
async def connect(dsn=None, *,
    ...
    :param password:
        ...
        utils users and applications may be able to read it without needing
